...
val accountList = listOf<Account>(
    Account(icon =  R.drawable.panda,userName = "Ridhim Jain",email = "ridhimjain41001@gmail.com",unReadMails = 99),
    Account(userName = "Chris Morty",email = "chris@gmail.com",unReadMails =65),
    Account(userName = "Christy Jane",email = "jane@gmail.com",unReadMails = 4)
)